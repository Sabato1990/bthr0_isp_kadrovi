...
class ServiceFactory {
  ...
  static createService (metadata, edmConfiguration = {}) {
    ...
    // put provider into global map for cross-service
    cds._edmProviders = cds._edmProviders || new Map()
    const { namespace } = edmProvider._provider._containerName
    cds._edmProviders.set(namespace, edmProvider)
